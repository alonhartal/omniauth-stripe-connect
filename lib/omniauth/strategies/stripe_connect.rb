...
module OmniAuth
  module Strategies
    class SfStripeConnect < OmniAuth::Strategies::OAuth2
      option :name, :sf_stripe_connect
    ...
    class LaStripeConnect < OmniAuth::Strategies::OAuth2
      option :name, :la_stripe_connect
